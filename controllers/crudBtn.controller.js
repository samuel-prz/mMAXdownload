...
controllers.editButtons = async (req,res) => {
    try{
               //realizamos una  consulta ,
        //console.log(req.body.pTexto) 
        var createButtons = await pool.query("UPDATE `botones` SET `btn_texto` = '"+req.body.pTexto+"', `btn_link` = '"+req.body.pLink+"', `btn_color` = '"+req.body.pColor+"', `btn_version` = '"+req.body.pVersion+"' WHERE `botones`.`btn_id` = "+req.body.pID+" ");
